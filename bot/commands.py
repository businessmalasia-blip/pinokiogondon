...
async def cmd_settings(message: Message, ctx) -> None:
    ...
    lines = [
        ...
        "",
        "🕐 <b>Торговые сессии</b>",
        f"  Режим: {'✅ включён (EU/US)' if s.trading_hours_enabled else '🔓 отключён (круглосуточно)'}",
        ...
        f"{f' (окно {s.dev_early_sell_window_minutes} мин)' if s.dev_early_sell_protection else ''}",
